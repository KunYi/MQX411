...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrvf65gs10_a5.ds5/debug/psp/psp.a(linker_symbols.o)
LIBRARIES += $(MQX_ROOTDIR)/lib/twrvf65gs10_a5.ds5/debug/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrvf65gs10_a5.ds5/debug/rtcs/rtcs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrvf65gs10_a5.ds5/debug/shell/shell.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrvf65gs10_a5.ds5/debug/usb/usbh.a
endif
ifeq ($(CONFIG),release)
...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrvf65gs10_a5.ds5/release/psp/psp.a(linker_symbols.o)
LIBRARIES += $(MQX_ROOTDIR)/lib/twrvf65gs10_a5.ds5/release/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrvf65gs10_a5.ds5/release/rtcs/rtcs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrvf65gs10_a5.ds5/release/shell/shell.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrvf65gs10_a5.ds5/release/usb/usbh.a
endif
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrvf65gs10_a5.ds5/debug/bsp/Sources
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrvf65gs10_a5.ds5/debug/rtcs
INCLUDE += $(MQX_ROOTDIR)/lib/twrvf65gs10_a5.ds5/debug/shell
INCLUDE += $(MQX_ROOTDIR)/lib/twrvf65gs10_a5.ds5/debug/usb
endif
ifeq ($(CONFIG),release)
INCLUDE += $(MQX_ROOTDIR)/lib/twrvf65gs10_a5.ds5/release/bsp/Generated_Code
INCLUDE += $(MQX_ROOTDIR)/lib/twrvf65gs10_a5.ds5/release/bsp/Sources
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrvf65gs10_a5.ds5/release/rtcs
INCLUDE += $(MQX_ROOTDIR)/lib/twrvf65gs10_a5.ds5/release/shell
INCLUDE += $(MQX_ROOTDIR)/lib/twrvf65gs10_a5.ds5/release/usb
endif

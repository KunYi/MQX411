...
LIBRARIES += $(MQX_ROOTDIR)/lib/vybrid_autoevb_a5.ds5/debug/rtcs/rtcs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/vybrid_autoevb_a5.ds5/debug/shell/shell.a
LIBRARIES += $(MQX_ROOTDIR)/lib/vybrid_autoevb_a5.ds5/debug/usb/usbh.a
endif
ifeq ($(CONFIG),release)
...
LIBRARIES += $(MQX_ROOTDIR)/lib/vybrid_autoevb_a5.ds5/release/rtcs/rtcs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/vybrid_autoevb_a5.ds5/release/shell/shell.a
LIBRARIES += $(MQX_ROOTDIR)/lib/vybrid_autoevb_a5.ds5/release/usb/usbh.a
endif
...
INCLUDE += $(MQX_ROOTDIR)/lib/vybrid_autoevb_a5.ds5/debug/rtcs
INCLUDE += $(MQX_ROOTDIR)/lib/vybrid_autoevb_a5.ds5/debug/shell
INCLUDE += $(MQX_ROOTDIR)/lib/vybrid_autoevb_a5.ds5/debug/usb
endif
ifeq ($(CONFIG),release)
...
INCLUDE += $(MQX_ROOTDIR)/lib/vybrid_autoevb_a5.ds5/release/rtcs
INCLUDE += $(MQX_ROOTDIR)/lib/vybrid_autoevb_a5.ds5/release/shell
INCLUDE += $(MQX_ROOTDIR)/lib/vybrid_autoevb_a5.ds5/release/usb
endif

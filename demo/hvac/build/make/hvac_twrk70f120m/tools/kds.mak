...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk70f120m.kds/debug/rtcs/rtcs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk70f120m.kds/debug/shell/shell.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk70f120m.kds/debug/usb/usbh.a
endif
ifeq ($(CONFIG),release)
...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk70f120m.kds/release/rtcs/rtcs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk70f120m.kds/release/shell/shell.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk70f120m.kds/release/usb/usbh.a
endif
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk70f120m.kds/debug/bsp/Sources
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk70f120m.kds/debug/rtcs
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk70f120m.kds/release/bsp/Sources
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk70f120m.kds/release/rtcs

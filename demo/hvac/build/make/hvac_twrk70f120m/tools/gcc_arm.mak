...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk70f120m.gcc_arm/debug/rtcs/rtcs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk70f120m.gcc_arm/debug/shell/shell.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk70f120m.gcc_arm/debug/usb/usbh.a
endif
ifeq ($(CONFIG),release)
...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk70f120m.gcc_arm/release/rtcs/rtcs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk70f120m.gcc_arm/release/shell/shell.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk70f120m.gcc_arm/release/usb/usbh.a
endif
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk70f120m.gcc_arm/debug/bsp/Sources
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk70f120m.gcc_arm/debug/rtcs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk70f120m.gcc_arm/debug/shell
INCLUDE += $(MQX_ROOTDIR)/lib/twrk70f120m.gcc_arm/debug/usb
endif
ifeq ($(CONFIG),release)
INCLUDE += $(MQX_ROOTDIR)/lib/twrk70f120m.gcc_arm/release/bsp/Generated_Code
INCLUDE += $(MQX_ROOTDIR)/lib/twrk70f120m.gcc_arm/release/bsp/Sources
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk70f120m.gcc_arm/release/rtcs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk70f120m.gcc_arm/release/shell
INCLUDE += $(MQX_ROOTDIR)/lib/twrk70f120m.gcc_arm/release/usb
endif

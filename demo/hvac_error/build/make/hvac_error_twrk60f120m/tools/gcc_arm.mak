...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.gcc_arm/debug/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.gcc_arm/debug/rtcs/rtcs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.gcc_arm/debug/shell/shell.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.gcc_arm/debug/usb/usbh.a
endif
ifeq ($(CONFIG),release)
...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.gcc_arm/release/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.gcc_arm/release/rtcs/rtcs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.gcc_arm/release/shell/shell.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.gcc_arm/release/usb/usbh.a
endif
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60f120m.gcc_arm/debug/bsp/Sources
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60f120m.gcc_arm/debug/mfs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60f120m.gcc_arm/debug/rtcs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60f120m.gcc_arm/debug/shell
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60f120m.gcc_arm/release/bsp/Sources
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60f120m.gcc_arm/release/mfs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60f120m.gcc_arm/release/rtcs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60f120m.gcc_arm/release/shell

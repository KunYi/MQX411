...
# common settings
AS_FLAGS += -mcpu=cortex-m4 -mfloat-abi=soft -std=gnu99 -Wall -mthumb -g2 -gdwarf-2 -gstrict-dwarf -x assembler-with-cpp -Xassembler --no-warn 
CC_FLAGS += -mcpu=cortex-m4 -mfloat-abi=soft -std=gnu99 -ffunction-sections -fdata-sections -Wall -mthumb -g2 -gdwarf-2 -gstrict-dwarf -fno-strict-aliasing -Wno-missing-braces -Wno-switch -Wno-unused-value -Wno-unused-variable -Wno-unused-but-set-variable -Wno-pointer-to-int-cast -Wno-unused-function -Wno-unused-label -Wno-char-subscripts -Wno-int-to-pointer-cast 
CX_FLAGS += -mcpu=cortex-m4 -mfloat-abi=soft -fno-exceptions -ffunction-sections -fdata-sections -Wall -mthumb -g2 -gdwarf-2 -gstrict-dwarf -fno-strict-aliasing -Wno-missing-braces 
LD_FLAGS += -mcpu=cortex-m4 -mfloat-abi=soft -std=gnu99 -nostartfiles -nodefaultlibs -nostdlib -Xlinker --gc-sections -Xlinker -cref -Xlinker -static -mthumb -g2 -gdwarf-2 -gstrict-dwarf -Xlinker -z -Xlinker muldefs 

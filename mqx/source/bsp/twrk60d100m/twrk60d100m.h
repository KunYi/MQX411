...
*   Freescale TWR-K60D100M Evaluation board.
*
*
*END************************************************************************/

#ifndef _twrk60d100m_h_
    #define _twrk60d100m_h_  1
...
#define BSP_I2C0_PORT_BASE                  (PORTD_BASE_PTR)
#define BSP_I2C0_PORT_VECTOR                (INT_PORTD)
#define BSP_I2C0_SDA_PIN_NUM                (9)
...
#define BSP_DEFAULT_END_OF_USER_DEFAULT_MEMORY              ((void *)&Image$$USB_BDT$$Base)

#define BSP_DEFAULT_START_OF_USER_RW_MEMORY                 ((void *)&Image$$RWUSER$$Base)
#define BSP_DEFAULT_END_OF_USER_RW_MEMORY                   ((void *)&Image$$DATA$$Base)

#define BSP_DEFAULT_START_OF_USER_RO_MEMORY                 ((void *)&Image$$ROUSER$$Base)
#define BSP_DEFAULT_END_OF_USER_RO_MEMORY                   ((void *)&Image$$RWUSER$$Base)

#define BSP_DEFAULT_START_OF_USER_NO_MEMORY                 ((void *)&Image$$NOUSER$$Base)
#define BSP_DEFAULT_END_OF_USER_NO_MEMORY                   ((void *)&Image$$ROUSER$$Base)
...
#else
#error Your compiler does not support Usermode
#endif
...
#define BSP_DEFAULT_START_OF_USER_HEAP                      ((void *)(16 * 1024))  //((void *)__sfb("USER_HEAP"))
#define BSP_DEFAULT_END_OF_USER_HEAP                        ((void *)0)            //((void *)__USER_HEAP_END)

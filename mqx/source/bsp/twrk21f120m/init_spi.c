...
#if (BSPCFG_DSPI1_USE_DMA || BSPCFG_DSPI2_USE_DMA)
#error It is not possible to configure SPI1 and SPI2 for the DMA mode on this platform due to RX/TX sharing the same DMA channel, see the Reference Manual for the K21F120M.
#endif
/*

...
const KUART_INIT_STRUCT _bsp_sci0_init = {
   ...
   /* RX/TX Int vect     */ NVIC_UART0,
   /* ERR Int vect       */ 0, //INT_UART0_ERR,
   /* RX/TX priority     */ 3,
   /* ERR priority       */ 4
#if MQX_ENABLE_LOW_POWER   
   ,
...
const KUART_INIT_STRUCT _bsp_sci2_init = {
   ...
   /* RX/TX Int vect     */ NVIC_UART2,
   /* ERR Int vect       */ 0, //INT_UART2_ERR,
   /* RX/TX priority     */ 3,
   /* ERR priority       */ 4
#if MQX_ENABLE_LOW_POWER   
   ,
   /* Clock source       */ CM_CLOCK_SOURCE_IPG,
...
const KUART_INIT_STRUCT _bsp_sci3_init = {
   ...
   /* RX/TX Int vect     */ NVIC_UART3,
   /* ERR Int vect       */ 0, //INT_UART3_ERR,
   /* RX/TX priority     */ 3,
   /* ERR priority       */ 4
#if MQX_ENABLE_LOW_POWER   
   ,
...
const KUART_INIT_STRUCT _bsp_sci4_init = {
   ...
   /* RX/TX Int vect     */ NVIC_UART4,
   /* ERR Int vect       */ 0, //INT_UART4_ERR,
   /* RX/TX priority     */ 3,
   /* ERR priority       */ 4
#if MQX_ENABLE_LOW_POWER   
   ,
...
const KUART_INIT_STRUCT _bsp_sci5_init = {
   ...
   /* RX/TX Int vect     */ NVIC_UART5,
   /* ERR Int vect       */ 0, //INT_UART5_ERR,
   /* RX/TX priority     */ 3,
   /* ERR priority       */ 4
#if MQX_ENABLE_LOW_POWER   
   ,

...
*/
#define BSP_TWR_VF65GS10_M4                 1
#define BSP_NAME                            "TWRVF65GS10_M4"
...
**
*/
#define BSP_DMA_BASE_PTRS                      { NULL, DMA1_BASE_PTR }
#define BSP_DMAMUX_BASE_PTRS                   { NULL, NULL, DMAMUX2_BASE_PTR, DMAMUX3_BASE_PTR }
...
#define BSP_LED2                            (LWGPIO_PIN_PTB1)
#define BSP_LED3                            (LWGPIO_PIN_PTB2)
#define BSP_LED4                            (LWGPIO_PIN_PTB3)
#define BSP_SW1                             (LWGPIO_PIN_PTB16)
#define BSP_SW2                             (LWGPIO_PIN_PTB17)
#define BSP_BUTTON1                         BSP_SW1
#define BSP_BUTTON2                         BSP_SW2

#define BSP_LED1_MUX_GPIO                   (LWGPIO_MUX_PTB0_GPIO)
#define BSP_LED2_MUX_GPIO                   (LWGPIO_MUX_PTB1_GPIO)
#define BSP_LED3_MUX_GPIO                   (LWGPIO_MUX_PTB2_GPIO)
#define BSP_LED4_MUX_GPIO                   (LWGPIO_MUX_PTB3_GPIO)
#define BSP_SW1_MUX_GPIO                    (LWGPIO_MUX_PTB16_GPIO)
#define BSP_SW2_MUX_GPIO                    (LWGPIO_MUX_PTB17_GPIO)
...
/* Use only one interface because the M4 Core has only 64KiB RAM */
...
#define BSP_DSPI0_DMA_RX_CHANNEL 48
#define BSP_DSPI0_DMA_TX_CHANNEL 49
#define BSP_DSPI0_DMA_RX_SOURCE  12
#define BSP_DSPI0_DMA_TX_SOURCE  13

#define BSP_DSPI1_DMA_RX_CHANNEL 50
#define BSP_DSPI1_DMA_TX_CHANNEL 51
...
#define BSP_SDCARD_GPIO_DETECT              (LWGPIO_PIN_PTA7)
#define BSP_SDCARD_DETECT_MUX_GPIO          (LWGPIO_MUX_PTA7_GPIO)
...
** MGCT: <option type="number" min="0" max="230400"/>
*/

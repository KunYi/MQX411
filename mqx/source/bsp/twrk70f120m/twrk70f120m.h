...
#ifndef _twrk70f120m_h_
    #define _twrk70f120m_h_  1
...
*/
#define BSP_TWR_K70F120M                     1
#define BSP_NAME                            "TWRK70F120M"
...
extern unsigned char __EXTERNAL_DDR2_ROM_BASE[],    __EXTERNAL_DDR2_ROM_SIZE[];
extern unsigned char __EXTERNAL_DDR2_RAM_BASE[],    __EXTERNAL_DDR2_RAM_SIZE[];
...
#endif /* __CC_ARM */
/*
 * MRAM cannot be reliably used on TWR_K70F120M due to a hardware conflict unless a hw modification is done:
...
#define BSP_EXTERNAL_DDR2_RAM_BASE          ((void *)__EXTERNAL_DDR2_RAM_BASE)
#define BSP_EXTERNAL_DDR2_RAM_SIZE          ((uint32_t)__EXTERNAL_DDR2_RAM_SIZE)
...
#define BSP_SW1                     (GPIO_PORT_D | GPIO_PIN0)
...
#define BSP_SW1_MUX_GPIO            (LWGPIO_MUX_D0_GPIO)
...
#define BSP_I2C0_PORT_BASE                  (PORTE_BASE_PTR)
#define BSP_I2C0_PORT_VECTOR                (INT_PORTE)
#define BSP_I2C0_SDA_PIN_NUM                (18)

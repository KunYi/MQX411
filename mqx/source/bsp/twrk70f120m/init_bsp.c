...
int _bsp_pre_init(void) {
    ...
    else
    {
        ...
        /* Uncached pool on this platform is enabled and placed to SRAM. We reuse uncached pool as SRAM pool */
...
int _bsp_init(void) {
   ...
   _io_sai_int_install(&_bsp_sai_init);
#endif
   ...
   _io_spi_install("spi2:", &_bsp_spi2_init);
    ...
    _io_adc_install("adc2:", (void *) &_bsp_adc2_init);
#endif
#if BSPCFG_ENABLE_ADC3
    _io_adc_install("adc3:", (void *) &_bsp_adc3_init);
#endif

...
{    
    ...
    if (actual_provider != twrpi_index)    /* changing provider */
    {
        ...
        switch(twrpi_index)        /* init new providers */
        {
            case BSP_TWRPI_VOID:
                /* init provider */
                hmi_twrpi_provider_keypad_ptr = hmi_tss_keypad_provider_init(hmi_init_table_tss_twrpi_void,0);
                ...
                break;
            case BSP_TWRPI_KEYPAD:
                hmi_twrpi_provider_keypad1_ptr = hmi_tss_keypad_provider_init(hmi_init_table_tss_twrpi_keypad,1);
                ...
                break;
            case BSP_TWRPI_ROTARY:
                hmi_twrpi_provider_rotaryA_ptr = hmi_tss_rotary_provider_init(hmi_init_table_tss_twrpi_rotary,3);
                hmi_twrpi_provider_rotaryB_ptr = hmi_tss_keypad_provider_init(hmi_init_table_tss_twrpi_rotary_keypad,2);

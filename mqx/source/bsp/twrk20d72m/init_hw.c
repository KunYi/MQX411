...
void _bsp_flexbus_setup (void)
{
    ...
    pctl->PCR[19] = PORT_PCR_MUX(ALT5); /* FB_OE */
...
*
*END*-------------------------------------------------------------------------*/
void _bsp_flexbus_mram_setup (const uint32_t base_address)
{
...
void init_hardware(void)
{
    ...
    /* Enable pin clocks */
    _bsp_gpio_io_init ();
    // TODO: disable flexbus when using SAI

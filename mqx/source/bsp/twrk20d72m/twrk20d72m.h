...
**                      FlexNVM
*/
#define BSP_EE_DATA_SIZE_CODE               (FLEXNVM_EE_SPLIT_1_1 | FLEXNVM_EE_SIZE_2048)
...
#define BSP_ADC_POTENTIOMETER           (ADC1_SOURCE_AD19)
#define BSP_ADC_CH_POT                  (ADC1_SOURCE_AD19)

...
static void clocks_init(void)
{
    ...
    // TODO: check divider for usb0 and usb 1 !!
...
//    CCM_CSCMR2 |= 3 << CCM_CSCMR2_RMII_CLK_SEL_SHIFT;  // from PLL5!!!, Faraday is clock source for phy...
    ...
    /* Enable SNVS */
    CCM_CCGR6 |= CCM_CCGR6_CG6_MASK | CCM_CCGR6_CG7_MASK;
}
...
static void ddr_init(void)
{
    ...
    CCM_CCGR6 |= CCM_CCGR6_CG14(0x3); // DDRMC
    ...
    // DRAM device Mode registers
    ddrmc->CR48 = ((MR1 << 16) | MR); // mr0, ddr3 burst of 8 only

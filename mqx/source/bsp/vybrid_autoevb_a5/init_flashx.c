...
const FLASHX_FILE_BLOCK _bsp_flashx_quadspi1_file_blocks[] = {
    {"bank0", QuadSPI1_MEMMAP_BASE, QuadSPI1_MEMMAP_END},
    {NULL, 0, 0 }
};
...
const FLASHX_BLOCK_INFO_STRUCT _flashx_quadspi0_block_map[] = {
    {128, 0,         0x40000, FLASHX_QUADSPI_A1_TAG},
    {128, 0x2000000, 0x40000, FLASHX_QUADSPI_B1_TAG},
    {0,   0,         0,       0xFFFFFFFF},
};

const FLASHX_BLOCK_INFO_STRUCT _flashx_quadspi1_block_map[] = {
    {128, 0,         0x40000, FLASHX_QUADSPI_A1_TAG},
    {0,   0,         0,       0xFFFFFFFF},
};
...
const FLASHX_QUADSPI_INIT_STRUCT _bsp_flashx_quadspi1_dev_init_data = {
...
const FLASHX_INIT_STRUCT _bsp_flashx_quadspi1_init = {
    QuadSPI1_MEMMAP_BASE, /* BASE_ADDR should be 0 for internal flashes */
    _flashx_quadspi1_block_map, /* HW block map for KinetisN devices */
    _bsp_flashx_quadspi1_file_blocks, /* Files on the device defined by the BSP */
    &_flashx_quadspi_if, /* Interface for low level driver */
    4, /* For external devices, data lines for the flash. Not used for internal flash devices. */
    0,  /* Number of parallel external flash devices. Not used for internal flash devices. */
    0,  /* 0 if the write verify is requested, non-zero otherwise */
    (void *) &_bsp_flashx_quadspi1_dev_init_data /* low level driver specific data */
};

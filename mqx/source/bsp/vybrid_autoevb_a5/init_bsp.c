...
int _bsp_pre_init(void) {
    ...
    if (_mqx_monitor_type == MQX_MONITOR_TYPE_NONE)
    {
        ...
        /* add qspi1 flash region area */
        _mmu_add_vregion((void *)__EXTERNAL_QSPI1_FLASH_BASE, (void *)__EXTERNAL_QSPI1_FLASH_BASE, __EXTERNAL_QSPI1_FLASH_SIZE, PSP_PAGE_TABLE_SECTION_SIZE(PSP_PAGE_TABLE_SECTION_SIZE_1MB) | PSP_PAGE_TYPE(PSP_PAGE_TYPE_CACHE_WBNWA) | PSP_PAGE_DESCR(PSP_PAGE_DESCR_ACCESS_RW_ALL));
         _mmu_venable();
...
#if BSPCFG_ENABLE_FLASHX_QUADSPI1
    _io_flashx_install("flashx_qspi1:", &_bsp_flashx_quadspi1_init);
#endif
 ...
 * Flashx interface for QuadSPI flash is preferred */
    ...
    _frd_ftm_quaddec_install("ftm1_quaddec:",
                (QUADDEC_INIT_INFO_STRUCT_PTR)&_bsp_ftm1_quaddec_init);
#endif

#if BSPCFG_ENABLE_FTM2_QD
    _frd_ftm_quaddec_install("ftm2_quaddec:",
                (QUADDEC_INIT_INFO_STRUCT_PTR)&_bsp_ftm2_quaddec_init);
#endif
...
#if BSPCFG_ENABLE_ESAI_TX1
    _vybrid_esai_vport_install("esai_tx1:",
        &_bsp_esai_vport1_tx_init, esai_fifo_handle);
#endif

#if BSPCFG_ENABLE_ESAI_TX2
    _vybrid_esai_vport_install("esai_tx2:",
        &_bsp_esai_vport2_tx_init, esai_fifo_handle);
#endif

#if BSPCFG_ENABLE_ESAI_TX3
    _vybrid_esai_vport_install("esai_tx3:",
        &_bsp_esai_vport3_tx_init, esai_fifo_handle);
#endif

#if BSPCFG_ENABLE_ESAI_TX4
    _vybrid_esai_vport_install("esai_tx4:",
        &_bsp_esai_vport4_tx_init, esai_fifo_handle);
#endif

#if BSPCFG_ENABLE_ESAI_TX5
    _vybrid_esai_vport_install("esai_tx5:",
        &_bsp_esai_vport5_tx_init, esai_fifo_handle);
#endif

#if BSPCFG_ENABLE_ESAI_RX0
    _vybrid_esai_vport_install("esai_rx0:",
        &_bsp_esai_vport5_rx_init, esai_fifo_handle);
#endif

#if BSPCFG_ENABLE_ESAI_RX1
    _vybrid_esai_vport_install("esai_rx1:",
        &_bsp_esai_vport4_rx_init, esai_fifo_handle);
#endif

#if BSPCFG_ENABLE_ESAI_RX2
    _vybrid_esai_vport_install("esai_rx2:",
        &_bsp_esai_vport3_rx_init, esai_fifo_handle);
#endif

#if BSPCFG_ENABLE_ESAI_RX3
    _vybrid_esai_vport_install("esai_rx3:",
        &_bsp_esai_vport2_rx_init, esai_fifo_handle);
#endif

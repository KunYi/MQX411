...
const KUART_INIT_STRUCT _bsp_sci0_init = {
   ...
   /* Channel            */ 0,
   /* Clock Speed        */ BSP_IPG_CLOCK,       /* SCI0 operates only on system clock */
   /* Baud rate          */ BSPCFG_SCI0_BAUD_RATE,
   /* RX/TX Int vect     */ INT_UART0,
...
const KUART_INIT_STRUCT _bsp_sci1_init = {
   ...
   /* Channel            */ 1,
   /* Clock Speed        */ BSP_IPG_CLOCK,   	/* SCI1 operates only on system clock */
...
const KUART_INIT_STRUCT _bsp_sci2_init = {
   ...
   /* Channel            */ 2,
   /* Clock Speed        */ BSP_IPG_CLOCK,       	/* SCI2 operates only on bus clock */

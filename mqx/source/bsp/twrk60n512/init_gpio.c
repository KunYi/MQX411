...
)
{
    ...
    switch (dev_num)
    {
        case 0:
            ...
            pctl->PCR[0] = PORT_PCR_MUX(2);     /* SPI0.PCS0   */
            pctl->PCR[1] = PORT_PCR_MUX(2);     /* SPI0.SCK    */
            pctl->PCR[2] = PORT_PCR_MUX(2);     /* SPI0.SOUT   */
...
)
{
    ...
    switch (dev_num)
    {
        case 0:
            ...
            pctl->PCR[9] |= PORT_PCR_IRQC(0x09);
            pctl->PCR[9] |= PORT_PCR_ISF_MASK;
#endif

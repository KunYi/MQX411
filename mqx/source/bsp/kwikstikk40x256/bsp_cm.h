...
#define CPU_PARTNUM_MK40DX256ZVMD10    /* Part number of the selected cpu */
...
#define CPU_OSCER_CLK_HZ_CONFIG_0       4000000UL /* System OSC external reference clock frequency in clock configuration 0 */
...
#define CPU_PLL_FLL_CLK_HZ_CONFIG_1     96000000UL /* PLL/FLL clock frequency in clock configuration 1 */
#define CPU_MCGIR_CLK_HZ_CONFIG_1       0UL /* MCG internal reference clock frequency in clock configuration 1 */
#define CPU_OSCER_CLK_HZ_CONFIG_1       4000000UL /* System OSC external reference clock frequency in clock configuration 1 */

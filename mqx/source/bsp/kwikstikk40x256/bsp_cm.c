...
/*
** ===================================================================
**     Method      :  Cpu_MCGAutoTrim (component MK40N512MD100)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_GetLLSWakeUpFlags (component MK40N512MD100)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_SetMCGModePEE (component MK40N512MD100)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_SetMCGModePBE (component MK40N512MD100)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_SetMCGModeFBE (component MK40N512MD100)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_SetMCGModeBLPI (component MK40N512MD100)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_SetMCGModeFBI (component MK40N512MD100)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_SetMCG (component MK40N512MD100)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_GetCurrentMCGMode (component MK40N512MD100)
**
**     Description :
...
static void Cpu_SetMCGModePEE(uint8_t CLKMode)
{
  switch (CLKMode) {
    case 0U:
      ...
      /* MCG_C1: CLKS=0,FRDIV=2,IREFS=0,IRCLKEN=0,IREFSTEN=0 */
      MCG_C1 = (uint8_t)0x10U;
      /* MCG_C2: ??=0,??=0,RANGE=1,HGO=1,EREFS=1,LP=0,IRCS=1 */
      MCG_C2 = (uint8_t)0x1DU;
...
static void Cpu_SetMCGModePBE(uint8_t CLKMode)
{
  switch (CLKMode) {
    case 0U:
      ...
      /* SIM_SOPT2: MCGCLKSEL=0 */
      SIM_SOPT2 &= (uint32_t)~0x01UL;
      /* MCG_C1: CLKS=2,FRDIV=2,IREFS=0,IRCLKEN=0,IREFSTEN=0 */
      MCG_C1 = (uint8_t)0x90U;
      /* MCG_C2: ??=0,??=0,RANGE=1,HGO=1,EREFS=1,LP=0,IRCS=1 */
      MCG_C2 = (uint8_t)0x1DU;
      /* MCG_C5: ??=0,PLLCLKEN=0,PLLSTEN=0,PRDIV=1 */
      MCG_C5 = (uint8_t)0x01U;
    ...
    case 1U:
      ...
      /* SIM_SOPT2: MCGCLKSEL=0 */
      SIM_SOPT2 &= (uint32_t)~0x01UL;
      /* MCG_C1: CLKS=2,FRDIV=2,IREFS=0,IRCLKEN=1,IREFSTEN=1 */
      MCG_C1 = (uint8_t)0x93U;
      /* MCG_C2: ??=0,??=0,RANGE=1,HGO=1,EREFS=1,LP=0,IRCS=1 */
      MCG_C2 = (uint8_t)0x1DU;
      /* MCG_C5: ??=0,PLLCLKEN=0,PLLSTEN=0,PRDIV=1 */
      MCG_C5 = (uint8_t)0x01U;
...
static void Cpu_SetMCGModeBLPI(uint8_t CLKMode)
{
  switch (CLKMode) {
    case 1U:
      ...
      /* MCG_C2: ??=0,??=0,RANGE=1,HGO=1,EREFS=1,LP=1,IRCS=1 */
      MCG_C2 = (uint8_t)0x1FU;
      /* OSC_CR: ERCLKEN=0,??=0,EREFSTEN=0,??=0,SC2P=0,SC4P=0,SC8P=0,SC16P=0 */
      OSC_CR = (uint8_t)0x00U;
...
/*
** ===================================================================
**     Method      :  Cpu_SetClockConfiguration (component MK40N512MD100)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_GetClockConfiguration (component MK40N512MD100)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_SetOperationMode (component MK40N512MD100)
**
**     Description :

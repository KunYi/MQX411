...
int _bsp_pre_init(void) {
    ...
    MC_PMPROT = MC_PMPROT_AVLP_MASK | MC_PMPROT_ALLS_MASK | MC_PMPROT_AVLLS3_MASK | MC_PMPROT_AVLLS2_MASK | MC_PMPROT_AVLLS1_MASK; // allow VLPx, LLS, VLLSx
...
#warning "This module's physical signals are not correctly routed on board version 4 and below. If you have such board, please avoid using this driver."

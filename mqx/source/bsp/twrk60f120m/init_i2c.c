...
const KI2C_INIT_STRUCT _bsp_i2c0_init = {
   ...
   BSP_I2C0_PORT_BASE,     /* I2C port base address */
   BSP_I2C0_PORT_VECTOR,   /* I2C port vector number */
   BSP_I2C0_SDA_PIN_NUM,   /* I2C SDA pin number */
#endif
};
...
#if BSPCFG_ENABLE_LEGACY_II2C_SLAVE
   BSP_I2C1_PORT_BASE,     /* I2C port base address */
   BSP_I2C1_PORT_VECTOR,   /* I2C port vector number */
   BSP_I2C1_SDA_PIN_NUM,   /* I2C SDA pin number */
#endif
};

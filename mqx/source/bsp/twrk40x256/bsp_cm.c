...
static void Cpu_SetMCGModePEE(uint8_t CLKMode)
{
  switch (CLKMode) {
    case 0U:
      ...
      /* MCG_C2: ??=0,??=0,RANGE=2,HGO=1,EREFS=1,LP=0,IRCS=1 */
...
static void Cpu_SetMCGModePBE(uint8_t CLKMode)
{
  switch (CLKMode) {
    ...
    case 1U:
      ...
      /* MCG_C2: ??=0,??=0,RANGE=2,HGO=1,EREFS=1,LP=0,IRCS=1 */
      MCG_C2 = (uint8_t)0x2DU;
      /* MCG_C5: ??=0,PLLCLKEN=0,PLLSTEN=0,PRDIV=2 */
...
static void Cpu_SetMCGModeBLPI(uint8_t CLKMode)
{
  switch (CLKMode) {
    case 1U:
      ...
      /* MCG_C2: ??=0,??=0,RANGE=2,HGO=1,EREFS=1,LP=1,IRCS=1 */
...
void PE_low_level_init(void)
{
  ...
  LLWU_ME = (uint8_t)((LLWU_ME & (uint8_t)~(uint8_t)0x9EU) | (uint8_t)0x21U);
...
** ###################################################################
**
**     This file was created by Processor Expert 5.3 [05.02]
**     for the Freescale Kinetis series of microcontrollers.
**
** ###################################################################
*/

/***** End of Processor Expert generated code taken taken from Cpu.c file ***/

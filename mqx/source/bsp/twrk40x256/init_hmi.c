...
static const HMI_LWGPIO_INIT_STRUCT hmi_init_table_lwgpio[]={    
        ...
        {HMI_BUTTON_5, BSP_SW2, BSP_BUTTON2_MUX_GPIO, HMI_LWGPIO_FLAG_DIRECTION_IN|HMI_LWGPIO_FLAG_ACTIVE_STATE_0|HMI_LWGPIO_FLAG_PULL_UP_ON},    /* BUTTON 1 */
        {HMI_BUTTON_6, BSP_SW1, BSP_BUTTON1_MUX_GPIO, HMI_LWGPIO_FLAG_DIRECTION_IN|HMI_LWGPIO_FLAG_ACTIVE_STATE_0|HMI_LWGPIO_FLAG_PULL_UP_ON},    /* BUTTON 2 */
        {0,0,0},
};

...
)
{
    ...
    switch (dev_num)
    {
        case 0:
            ...
            pctl->PCR[0] = PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;  /* SPI0.PCS0   */
            pctl->PCR[1] = PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;  /* SPI0.SCK    */
            pctl->PCR[2] = PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;  /* SPI0.SOUT   */
            pctl->PCR[3] = PORT_PCR_MUX(2);                      /* SPI0.SIN    */
...
)
{
    ...
    */
    PORT_PCR_REG(PORTB_BASE_PTR, 9) = PORT_PCR_MUX(0x01);
    GPIO_PDDR_REG(PTB_BASE_PTR) |= 0x00000200; // PB9 as output
    GPIO_PDOR_REG(PTB_BASE_PTR) |= 0x00000200; // PB9 in high level
#endif
...
)
{
    ...
    switch (dev_num)
    {
        case 0:
            pctl = (PORT_MemMapPtr)PORTA_BASE_PTR;
            /* PTA12 - I2S0_TXD */
            pctl->PCR[12] = PORT_PCR_MUX(ALT6);
            /* PTA15 - I2S0_RXD */
            pctl->PCR[15]  = PORT_PCR_MUX(ALT6);
            /* PTA13 - I2S0_TX_FS */
            pctl->PCR[13] = PORT_PCR_MUX(ALT6);
            /* PTA14 - I2S0_TX_BCLK */
            pctl->PCR[14] = PORT_PCR_MUX(ALT6);
            /* PTA17 - I2S0_MCLK */
            pctl->PCR[17]  = PORT_PCR_MUX(ALT6);

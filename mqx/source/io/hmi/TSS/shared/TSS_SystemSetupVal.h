...
***********************************************************************************************************************/
  ...
  #include "TSS_API.h"
  ...
  #if ((TSS_USE_KEYDETECTOR_VERSION != 1) && (TSS_USE_KEYDETECTOR_VERSION != 2))
    #error "TSS - TSS_USE_KEYDETECTOR_VERSION is set to invalid value"
  #endif
  ...
  #if (TSS_USE_BASELINE_INIT_DURATION > 254)
  ...
  #if (TSS_USE_AUTO_SENS_CALIB_INIT_DURATION > 254)
    #error "TSS - TSS_USE_AUTO_SENS_CALIB_INIT_DURATION is out of range"
  #endif

  #if (TSS_USE_AUTO_SENS_CALIB_LOW_LIMIT > 1)
    #error "TSS - TSS_USE_AUTO_SENS_CALIB_LOW_LIMIT is set to invalid value"
  #endif

  #if (TSS_USE_NOISE_MODE > 1)
    #error "TSS - TSS_USE_NOISE_MODE is set to invalid value"
  #endif

  #if (TSS_USE_NOISE_SIGNAL_LOG > 1)
    #error "TSS - TSS_USE_NOISE_SIGNAL_LOG is set to invalid value"
  #endif

  #if (TSS_USE_AFID_FAST_FILTER_RATIO > TSS_USE_AFID_SLOW_FILTER_RATIO)
    #error "TSS - TSS_USE_AFID_FAST_FILTER_RATIO can not be higher than TSS_USE_AFID_SLOW_FILTER_RATIO"
  #endif

  #if ((TSS_USE_AUTO_SENS_CALIB_INIT_DURATION+TSS_USE_BASELINE_INIT_DURATION) > 254)
    #error "TSS - TSS_USE_BASELINE_INIT_DURATION and TSS_USE_AUTO_SENS_CALIB_INIT_DURATION are out of range"
  #endif
  ...
  #if (TSS_USE_LOWPOWER_CALIBRATION > 1)
    #error "TSS - TSS_USE_LOWPOWER_CALIBRATION is set to invalid value"
  #endif

  #if TSS_USE_LOWPOWER_CALIBRATION
    #if (TSS_TSI_VERSION != 2)
      #error "TSS - TSS_USE_LOWPOWER_CALIBRATION is not supported on this MCU"
    #endif
  #endif

  #if (TSS_USE_LOWPOWER_THRESHOLD_BASELINE > 1)
    #error "TSS - TSS_USE_LOWPOWER_THRESHOLD_BASELINE is set to invalid value"
  #endif
    ...
    #error "TSS - Not defined TSS_N_CONTROLS"
        ...
        #error "TSS - Not defined TSS_C0_TYPE"
          ...
          #error "TSS - Invalid control type for C0"
        #else
        #ifdef TSS_OLD_CONTROL_EL_DEF_USED
            ...
            #error "TSS - TSS_C0_INPUTS is not defined."
          #endif
          #if (TSS_C0_TYPE == TSS_CT_MATRIX)
            #ifndef TSS_C0_INPUTS_NUM_X
              #error "TSS - TSS_C0_INPUTS_NUM_X is not defined."
            #else
              #if ((TSS_C0_INPUTS_NUM_X < 2) || (TSS_C0_INPUTS_NUM_X > 14))
                #error "TSS - Invalid quantity of matrix electrodes on X axis for C0"
              #endif
            #endif
          #endif
        #endif
        ...
        #error "TSS - Not defined TSS_C1_TYPE"
          ...
          #error "TSS - Invalid control type for C1"
            ...
            #error "TSS - TSS_C1_INPUTS is not defined."
          #endif
          #if (TSS_C1_TYPE == TSS_CT_MATRIX)
            #ifndef TSS_C1_INPUTS_NUM_X
              #error "TSS - TSS_C1_INPUTS_NUM_X is not defined."
            #else
              #if ((TSS_C1_INPUTS_NUM_X < 2) || (TSS_C1_INPUTS_NUM_X > 14))
                #error "TSS - Invalid quantity of matrix electrodes on X axis for C1"
              #endif
            #endif
          #endif
        #endif
        ...
        #error "TSS - Not defined TSS_C2_TYPE"
          ...
          #error "TSS - Invalid control type for C2"
            ...
            #error "TSS - TSS_C2_INPUTS is not defined."
          #endif
          #if (TSS_C2_TYPE == TSS_CT_MATRIX)
            #ifndef TSS_C2_INPUTS_NUM_X
              #error "TSS - TSS_C2_INPUTS_NUM_X is not defined."
            #else
              #if ((TSS_C2_INPUTS_NUM_X < 2) || (TSS_C2_INPUTS_NUM_X > 14))
                #error "TSS - Invalid quantity of matrix electrodes on X axis for C2"
              #endif
            #endif
          #endif
        #endif
        ...
        #error "TSS - Not defined TSS_C3_TYPE"
          ...
          #error "TSS - Invalid control type for C3"
            ...
            #error "TSS - TSS_C3_INPUTS is not defined."
          #endif
          #if (TSS_C3_TYPE == TSS_CT_MATRIX)
            #ifndef TSS_C3_INPUTS_NUM_X
              #error "TSS - TSS_C3_INPUTS_NUM_X is not defined."
            #else
              #if ((TSS_C3_INPUTS_NUM_X < 2) || (TSS_C3_INPUTS_NUM_X > 14))
                #error "TSS - Invalid quantity of matrix electrodes on X axis for C3"
              #endif
            #endif
          #endif
        #endif
        ...
        #error "TSS - Not defined TSS_C4_TYPE"
          ...
          #error "TSS - Invalid control type for C4"
            ...
            #error "TSS - TSS_C4_INPUTS is not defined."
          #endif
          #if (TSS_C4_TYPE == TSS_CT_MATRIX)
            #ifndef TSS_C4_INPUTS_NUM_X
              #error "TSS - TSS_C4_INPUTS_NUM_X is not defined."
            #else
              #if ((TSS_C4_INPUTS_NUM_X < 2) || (TSS_C4_INPUTS_NUM_X > 14))
                #error "TSS - Invalid quantity of matrix electrodes on X axis for C4"
              #endif
            #endif
          #endif
        #endif
        ...
        #error "TSS - Not defined TSS_C5_TYPE"
          ...
          #error "TSS - Invalid control type for C5"
            ...
            #error "TSS - TSS_C5_INPUTS is not defined."
          #endif
          #if (TSS_C5_TYPE == TSS_CT_MATRIX)
            #ifndef TSS_C5_INPUTS_NUM_X
              #error "TSS - TSS_C5_INPUTS_NUM_X is not defined."
            #else
              #if ((TSS_C5_INPUTS_NUM_X < 2) || (TSS_C5_INPUTS_NUM_X > 14))
                #error "TSS - Invalid quantity of matrix electrodes on X axis for C5"
              #endif
            #endif
          #endif
        #endif
        ...
        #error "TSS - Not defined TSS_C6_TYPE"
          ...
          #error "TSS - Invalid control type for C6"
            ...
            #error "TSS - TSS_C6_INPUTS is not defined."
          #endif
          #if (TSS_C6_TYPE == TSS_CT_MATRIX)
            #ifndef TSS_C6_INPUTS_NUM_X
              #error "TSS - TSS_C6_INPUTS_NUM_X is not defined."
            #else
              #if ((TSS_C6_INPUTS_NUM_X < 2) || (TSS_C6_INPUTS_NUM_X > 14))
                #error "TSS - Invalid quantity of matrix electrodes on X axis for C6"
              #endif
            #endif
          #endif
        #endif
        ...
        #error "TSS - Not defined TSS_C7_TYPE"
          ...
          #error "TSS - Invalid control type for C7"
            ...
            #error "TSS - TSS_C7_INPUTS is not defined."
          #endif
          #if (TSS_C7_TYPE == TSS_CT_MATRIX)
            #ifndef TSS_C7_INPUTS_NUM_X
              #error "TSS - TSS_C7_INPUTS_NUM_X is not defined."
            #else
              #if ((TSS_C7_INPUTS_NUM_X < 2) || (TSS_C7_INPUTS_NUM_X > 14))
                #error "TSS - Invalid quantity of matrix electrodes on X axis for C7"
              #endif
            #endif
          #endif
        #endif
        ...
        #error "TSS - Not defined TSS_C8_TYPE"
          ...
          #error "TSS - Invalid control type for C8"
            ...
            #error "TSS - TSS_C8_INPUTS is not defined."
          #endif
          #if (TSS_C8_TYPE == TSS_CT_MATRIX)
            #ifndef TSS_C8_INPUTS_NUM_X
              #error "TSS - TSS_C8_INPUTS_NUM_X is not defined."
            #else
              #if ((TSS_C8_INPUTS_NUM_X < 2) || (TSS_C8_INPUTS_NUM_X > 14))
                #error "TSS - Invalid quantity of matrix electrodes on X axis for C8"
              #endif
            #endif
          #endif
        #endif
        ...
        #error "TSS - Not defined TSS_C9_TYPE"
          ...
          #error "TSS - Invalid control type for C9"
            ...
            #error "TSS - TSS_C9_INPUTS is not defined."
          #endif
          #if (TSS_C9_TYPE == TSS_CT_MATRIX)
            #ifndef TSS_C9_INPUTS_NUM_X
              #error "TSS - TSS_C9_INPUTS_NUM_X is not defined."
            #else
              #if ((TSS_C9_INPUTS_NUM_X < 2) || (TSS_C9_INPUTS_NUM_X > 14))
                #error "TSS - Invalid quantity of matrix electrodes on X axis for C9"
              #endif
            #endif
          #endif
        #endif
        ...
        #error "TSS - Not defined TSS_C10_TYPE"
          ...
          #error "TSS - Invalid control type for C10"
            ...
            #error "TSS - TSS_C10_INPUTS is not defined."
          #endif
          #if (TSS_C10_TYPE == TSS_CT_MATRIX)
            #ifndef TSS_C10_INPUTS_NUM_X
              #error "TSS - TSS_C10_INPUTS_NUM_X is not defined."
            #else
              #if ((TSS_C10_INPUTS_NUM_X < 2) || (TSS_C10_INPUTS_NUM_X > 14))
                #error "TSS - Invalid quantity of matrix electrodes on X axis for C10"
              #endif
            #endif
          #endif
        #endif
        ...
        #error "TSS - Not defined TSS_C11_TYPE"
          ...
          #error "TSS - Invalid control type for C11"
            ...
            #error "TSS - TSS_C11_INPUTS is not defined."
          #endif
          #if (TSS_C11_TYPE == TSS_CT_MATRIX)
            #ifndef TSS_C11_INPUTS_NUM_X
              #error "TSS - TSS_C11_INPUTS_NUM_X is not defined."
            #else
              #if ((TSS_C11_INPUTS_NUM_X < 2) || (TSS_C11_INPUTS_NUM_X > 14))
                #error "TSS - Invalid quantity of matrix electrodes on X axis for C11"
              #endif
            #endif
          #endif
        #endif
        ...
        #error "TSS - Not defined TSS_C12_TYPE"
          ...
          #error "TSS - Invalid control type for C12"
            ...
            #error "TSS - TSS_C12_INPUTS is not defined."
          #endif
          #if (TSS_C12_TYPE == TSS_CT_MATRIX)
            #ifndef TSS_C12_INPUTS_NUM_X
              #error "TSS - TSS_C12_INPUTS_NUM_X is not defined."
            #else
              #if ((TSS_C12_INPUTS_NUM_X < 2) || (TSS_C12_INPUTS_NUM_X > 14))
                #error "TSS - Invalid quantity of matrix electrodes on X axis for C12"
              #endif
            #endif
          #endif
        #endif
        ...
        #error "TSS - Not defined TSS_C13_TYPE"
          ...
          #error "TSS - Invalid control type for C13"
            ...
            #error "TSS - TSS_C13_INPUTS is not defined."
          #endif
          #if (TSS_C13_TYPE == TSS_CT_MATRIX)
            #ifndef TSS_C13_INPUTS_NUM_X
              #error "TSS - TSS_C13_INPUTS_NUM_X is not defined."
            #else
              #if ((TSS_C13_INPUTS_NUM_X < 2) || (TSS_C13_INPUTS_NUM_X > 14))
                #error "TSS - Invalid quantity of matrix electrodes on X axis for C13"
              #endif
            #endif
          #endif
        #endif
        ...
        #error "TSS - Not defined TSS_C14_TYPE"
          ...
          #error "TSS - Invalid control type for C14"
            ...
            #error "TSS - TSS_C14_INPUTS is not defined."
          #endif
          #if (TSS_C14_TYPE == TSS_CT_MATRIX)
            #ifndef TSS_C14_INPUTS_NUM_X
              #error "TSS - TSS_C14_INPUTS_NUM_X is not defined."
            #else
              #if ((TSS_C14_INPUTS_NUM_X < 2) || (TSS_C14_INPUTS_NUM_X > 14))
                #error "TSS - Invalid quantity of matrix electrodes on X axis for C14"
              #endif
            #endif
          #endif
        #endif
        ...
        #error "TSS - Not defined TSS_C15_TYPE"
          ...
          #error "TSS - Invalid control type for C15"
            ...
            #error "TSS - TSS_C15_INPUTS is not defined."
          #endif
          #if (TSS_C15_TYPE == TSS_CT_MATRIX)
            #ifndef TSS_C15_INPUTS_NUM_X
              #error "TSS - TSS_C15_INPUTS_NUM_X is not defined."
            #else
              #if ((TSS_C15_INPUTS_NUM_X < 2) || (TSS_C15_INPUTS_NUM_X > 14))
                #error "TSS - Invalid quantity of matrix electrodes on X axis for C15"
              #endif
            #endif
          #endif
        #endif
  ...
  **************************************************************************************/
  ...
  /**************************************************************************************
  *                            Validation of Keydetector selection
  **************************************************************************************/

  #if (TSS_USE_KEYDETECTOR_VERSION == 2)
    #if (TSS_HCS08_MCU == 1)
      #error "TSS - TSS_USE_KEYDETECTOR_VERSION version 2 is not supported on the MCU "
    #endif
    #if TSS_USE_SIGNAL_SHIELDING
      #error "TSS - TSS_USE_SIGNAL_SHIELDING is set to invalid value. Signal Shielding is not supported in TSS_USE_KEYDETECTOR_VERSION version 2"
    #endif
  #endif

  /**************************************************************************************
  *                            Validation of noise mode                                 *
  **************************************************************************************/
  #if ((TSS_TSI_SUPPORTS_NOISE_MODE == 0) && (TSS_USE_NOISE_MODE == 1))
    #error "Noise mode is not available for selected MCU"
  #endif

  #if ((TSS_USE_NOISE_MODE == 1) && (TSS_USE_SIMPLE_LOW_LEVEL == 1))
    #error "Noise mode not available for Simple mode"
  #endif

...
***********************************************************************************************************************/
  ...
  *******************************************************/
  ...
  #define TSS_HW_MTIM_SC                   *(volatile uint8_t  *)(TSS_HW_TIMER_ADDRESS+0) 
  #define TSS_HW_MTIM_CLK                  *(volatile uint8_t  *)(TSS_HW_TIMER_ADDRESS+1)
  #define TSS_HW_MTIM_CNT                  *(volatile uint8_t  *)(TSS_HW_TIMER_ADDRESS+2)
  #define TSS_HW_MTIM_MOD                  *(volatile uint8_t  *)(TSS_HW_TIMER_ADDRESS+3)
  ...
  #if TSS_KINETIS_MCU || TSS_CFM_MCU
    #define TSS_HW_TPMFTM_SC                 *(volatile uint8_t  *)(TSS_HW_TIMER_ADDRESS+0) 
    #define TSS_HW_TPMFTM_CNT                *(volatile uint16_t *)(TSS_HW_TIMER_ADDRESS+1)
    #define TSS_HW_TPMFTM_MOD                *(volatile uint16_t *)(TSS_HW_TIMER_ADDRESS+2)
  #else 
    #define TSS_HW_TPMFTM_SC                 *(volatile uint8_t  *)(TSS_HW_TIMER_ADDRESS+0) 
    #define TSS_HW_TPMFTM_CNT                *(volatile uint16_t *)(TSS_HW_TIMER_ADDRESS+1)
    #define TSS_HW_TPMFTM_CNTH               *(volatile uint8_t  *)(TSS_HW_TIMER_ADDRESS+1)
    #define TSS_HW_TPMFTM_CNTL               *(volatile uint8_t  *)(TSS_HW_TIMER_ADDRESS+2)
    #define TSS_HW_TPMFTM_MOD                *(volatile uint16_t *)(TSS_HW_TIMER_ADDRESS+3)
    #define TSS_HW_TPMFTM_MODH               *(volatile uint8_t  *)(TSS_HW_TIMER_ADDRESS+3)
    #define TSS_HW_TPMFTM_MODL               *(volatile uint8_t  *)(TSS_HW_TIMER_ADDRESS+4)
  #endif
  ...
  /*! TPM and FTM - Peripheral register structure */
    ...
    #define TSS_HW_TIMER_SET_PRESCALE(x)     (TSS_HW_MTIM_CLK = ((uint8_t)(TSS_HW_MTIM_CLK & ((uint8_t)(~(uint8_t)TSS_HW_MTIM_PRESCALE_MASK)))) | (x))   /*Changed due to MISRA*/
    ...
    #define TSS_HW_TIMER_SET_PRESCALE(x)     (TSS_HW_TPMFTM_SC = (uint8_t)((TSS_HW_TPMFTM_SC & (~TSS_HW_TPMFTM_PRESCALE_MASK)) | (x)))   /*Changed due to MISRA*/

...
***********************************************************************************************************************/
  ...
  /***************************** Types ***************************/
    ...
    typedef struct {
      ...
      const uint32_t * const tsi_cpsu32Module;
      const uint8_t tsi_u8ModuleIRQNum;
      const uint8_t tsi_u8TriggerSource;
      const uint8_t tsi_u8LowPowerControlSource;
    ...
    typedef struct {
      ...
      uint16_t tsi_au16Resolution;
        ...
        uint8_t tsi_u8LowPowerThresholdRatio;
      #endif
    ...
    typedef struct {
      ...
      const uint32_t tsi_cu32ChannelNum;
    } TSS_TSI_ELECTRODE_ROMDATA;
    ...
    typedef struct {
      ...
      typedef struct {
        ...
        uint16_t tsi_u16Counter[16];  /**< Counter Register, array offset: 0x100, array step: 0x4 */
  ...
  uint8_t TSI_SensorInit(uint8_t u8Command);
  /*
  ...
  */
  ...
  brief:      Performs a valid reading of one electrode, and returns
              a status code
  ...
  */
  ...
  /*************** Sample Electrode Routine assignment *************/
    ...
    **************************************************************************/
    ...
    #endif
    #ifndef TSS_TSI_SMOD
      #define TSS_TSI_SMOD           0 /* Set Scan Modulo ( 0 - 255 ) */
    #endif
    /* Low Power TSI definition */
    #ifndef TSS_TSI_LPCLKS
    ...
    #ifndef TSS_TSI_LPSCNITV
      #define TSS_TSI_LPSCNITV       0 /* Set Low Power Mode Scan Interval ( 0 = 1ms, 15 = 500ms ) */
    #endif
    ...
    #define TSS_TSI_RECALIBRATION_LOW_THRESHOLD(resolution)           (uint16_t)(((uint32_t)(resolution)*13107) >> 16u)
    #define TSS_TSI_RECALIBRATION_HIGH_THRESHOLD(resolution)          (0xFFFF-TSS_TSI_RECALIBRATION_HIGH_THRESHOLD_RANGE(resolution))
    #define TSS_TSI_RECALIBRATION_HIGH_THRESHOLD_RANGE(resolution)    (uint16_t)(((uint32_t)(0xFFFF-resolution)*13107) >> 16u)
    /* Fault Thresholds */
    #define TSS_TSI_CAP_LOW_LIMIT(resolution)                   (uint16_t)(((uint32_t)(resolution)*13107) >> 17u)
    #define TSS_TSI_CAP_HIGH_LIMIT(resolution)                  (0xFFFF-TSS_TSI_CAP_HIGH_LIMIT_RANGE(resolution))
    #define TSS_TSI_CAP_HIGH_LIMIT_RANGE(resolution)            (uint16_t)(((uint32_t)(0xFFFF-resolution)*13107) >> 17u)
    ...
    *********************************************************************************/
    ...
    #if (TSS_TSI_SMOD > 255)
      #error "TSS - TSS_TSI_SMOD is set to invalid value"
    #endif
    ...
    #if (TSS_TSI_LPSCNITV > 15)
      #error "TSS - TSS_TSI_LPSCNITV is set to invalid value"
    #endif

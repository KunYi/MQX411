...
_mqx_int _ksai_int_init(void *);
_mqx_int _ksai_int_deinit(void *, void *);    
_mqx_int _ksai_int_tx(void *, char *, uint32_t);
_mqx_int _ksai_int_rx(void *, char *, uint32_t);
_mqx_int _ksai_int_ioctl(void *, _mqx_int, void *);


_mqx_int _ksai_dma_init(void *);
_mqx_int _ksai_dma_deinit(void *, void *);    
_mqx_int _ksai_dma_tx(void *, char *, uint32_t);
_mqx_int _ksai_dma_rx(void *, char *, uint32_t);

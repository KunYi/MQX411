...
typedef struct io_sai_device_struct
{
    ...
    _mqx_int (_CODE_PTR_ DEV_INIT)(void *);

    /* The I/O deinit function */
    _mqx_int (_CODE_PTR_ DEV_DEINIT)(void *, void *);

    /* [IN] The READ function */
    _mqx_int (_CODE_PTR_ DEV_READ)(void *, char *, uint32_t);

    /* [IN] The WRITE function */
    _mqx_int (_CODE_PTR_ DEV_WRITE)(void *, char *, uint32_t);
...
extern "C" 
{
    ...
    _mqx_int _io_sai_int_open(MQX_FILE_PTR fd_ptr, char *open_name_ptr, char *flags);
    _mqx_int _io_sai_int_close(MQX_FILE_PTR fd_ptr);
    _mqx_int _io_sai_int_read(MQX_FILE_PTR fd_ptr, char *data_ptr, _mqx_int n);
    _mqx_int _io_sai_int_write(MQX_FILE_PTR fd_ptr, char *data_ptr, _mqx_int n);
    _mqx_int _io_sai_int_ioctl(MQX_FILE_PTR fd_ptr, _mqx_uint cmd, void *input_param_ptr);

...
static bool phy_dp83xxx_discover_addr(ENET_CONTEXT_STRUCT_PTR enet_ptr);
static bool phy_dp83xxx_init(ENET_CONTEXT_STRUCT_PTR enet_ptr);
static uint32_t phy_dp83xxx_get_speed(ENET_CONTEXT_STRUCT_PTR enet_ptr);
static bool phy_dp83xxx_get_link_status(ENET_CONTEXT_STRUCT_PTR enet_ptr);
...
static bool phy_dp83xxx_discover_addr
   (
...
static uint32_t phy_dp83xxx_get_speed
   (
       ENET_CONTEXT_STRUCT_PTR     enet_ptr
   )
{ 

...
uint32_t _ki2s_int_init (IO_I2S_DEVICE_STRUCT_PTR, char *);
uint32_t _ki2s_int_deinit (IO_I2S_DEVICE_STRUCT_PTR, KI2S_INFO_STRUCT_PTR);
uint32_t _ki2s_int_rx (IO_I2S_DEVICE_STRUCT_PTR, char *, uint32_t);
uint32_t _ki2s_int_tx (IO_I2S_DEVICE_STRUCT_PTR, char *, uint32_t);
uint32_t _ki2s_int_ioctl (KI2S_INFO_STRUCT_PTR io_info_ptr, uint32_t cmd, void *param_ptr);
static void _ki2s_int_isr (void *);
static uint32_t _ki2s_format_in_data(char *input, AUDIO_DATA_FORMAT_PTR format);
static void _ki2s_format_out_data(uint32_t input, char *output, AUDIO_DATA_FORMAT_PTR format);
static uint32_t _ki2s_sine_wave(uint32_t fs, uint32_t freq, int16_t **output);
static _mqx_int _ki2s_hw_init(KI2S_INIT_STRUCT_PTR, I2S_MemMapPtr);
static uint32_t _ki2s_get_mclk_value(KI2S_INFO_STRUCT_PTR io_info_ptr);
static _mqx_uint _ki2s_set_mclk_value(KI2S_INFO_STRUCT_PTR io_info_ptr, uint32_t frequency);
static _mqx_uint _ki2s_set_fs_value(KI2S_INFO_STRUCT_PTR io_info_ptr, uint32_t frequency);
/*FUNCTION****************************************************************
*
...
{ /* Body */
   ...
   return _io_i2s_install(identifier,
      (uint32_t (_CODE_PTR_)(void *, char *))_ki2s_int_init,
      (uint32_t (_CODE_PTR_)(void *, void *))_ki2s_int_deinit,
      (int32_t (_CODE_PTR_)(void *, char *, int32_t))_ki2s_int_rx,
      (int32_t (_CODE_PTR_)(void *, char *, int32_t))_ki2s_int_tx,
      (int32_t (_CODE_PTR_)(void *, uint32_t, uint32_t *))_ki2s_int_ioctl,
      (void *)init_data_ptr);
...
{ /* Body */
   ...
   io_info_ptr = (KI2S_INFO_STRUCT_PTR) _mem_alloc_system_zero ((uint32_t)sizeof (KI2S_INFO_STRUCT));
   if (NULL == io_info_ptr)
   {
...
{ /* Body */
   ...
   switch(cmd)
   {
      case IO_IOCTL_I2S_SET_MODE_MASTER:
         ...
         {
            #ifdef I2S_DEBUG
             printf("_i2s_ioctl - IO_IOCTL_I2S_SET_MODE_MASTER: Error - Cannot change I2S mode while I/O actions are in progress.\n");
            #endif
      ...
      case IO_IOCTL_I2S_SET_MODE_SLAVE:
         ...
         {
            #ifdef I2S_DEBUG
             printf("_i2s_ioctl - IO_IOCTL_I2S_SET_MODE_SLAVE: Error - Cannot change I2S mode while I/O actions are in progress.\n");
            #endif
            result = I2S_ERROR_DEVICE_BUSY;
            break;
         }
      ...
      case IO_IOCTL_I2S_SET_CLOCK_SOURCE_INT:
         ...
         {
            #ifdef I2S_DEBUG
             printf("_i2s_ioctl - IO_IOCTL_I2S_SET_CLOCK_SOURCE_INT: Error - Cannot change I2S clock source while I/O actions are in progress.\n");
            #endif
            result = I2S_ERROR_DEVICE_BUSY;
            break;
         }
         ...
         {
            #ifdef I2S_DEBUG
             printf("_i2s_ioctl - IO_IOCTL_I2S_SET_CLOCK_SOURCE_INT: Error - Cannot change I2S clock source while in slave mode.\n");
            #endif
      ...
      case IO_IOCTL_I2S_SET_CLOCK_SOURCE_EXT:
         ...
         {
            #ifdef I2S_DEBUG
             printf("_i2s_ioctl - IO_IOCTL_I2S_SET_CLOCK_SOURCE_EXT: Error - Cannot change I2S clock source while I/O actions are in progress.\n");
            #endif
            result = I2S_ERROR_DEVICE_BUSY;
            break;
         }
      ...
      case IO_IOCTL_I2S_SET_DATA_BITS:
         ...
         {
            #ifdef I2S_DEBUG
             printf("_i2s_ioctl - IO_IOCTL_I2S_SET_DATA_BITS: Error - Cannot change I2S data bit length while I/O actions are in progress.\n");
            #endif
            result = I2S_ERROR_DEVICE_BUSY;
            break;
         }
         ...
         else
         {
            ...
            i2s_ptr->TCCR |= (I2S_TCCR_WL((uint32_t) data_bits));
            i2s_ptr->RCCR &= ~(I2S_RCCR_WL_MASK);
            i2s_ptr->RCCR |= (I2S_RCCR_WL((uint32_t) data_bits));
            i2s_ptr->CR |= (I2S_CR_I2SEN_MASK);
      ...
      case IO_IOCTL_I2S_SET_MCLK_FREQ:
         ...
         {
            #ifdef I2S_DEBUG
             printf("_i2s_ioctl - IO_IOCTL_I2S_SET_MCLK_FREQ: Error - Cannot change I2S master clock frequency while I/O actions are in progress.\n");
            #endif
            result = I2S_ERROR_DEVICE_BUSY;
            break;
         }
         ...
         result = _ki2s_set_mclk_value(io_info_ptr, *((uint32_t *) param_ptr));
         break;
      ...
      case IO_IOCTL_I2S_SET_FS_FREQ:
         ...
         {
            #ifdef I2S_DEBUG
             printf("_i2s_ioctl - IO_IOCTL_I2S_SET_FS_FREQ: Error - Cannot change I2S sampling frequency while I/O actions are in progress.\n");
            #endif
            result = I2S_ERROR_DEVICE_BUSY;
            break;
         }
         ...
         frame_sync_freq = *((uint32_t *) param_ptr);
         if (frame_sync_freq == 0)
         {
              result = I2S_ERROR_INVALID_PARAMETER;
              break;
         }
         result = _ki2s_set_fs_value(io_info_ptr, *((uint32_t *) param_ptr));
         break;
      ...
      case IO_IOCTL_AUDIO_SET_IO_DATA_FORMAT:
         ...
         {
            uint8_t aligment, endianity, bits, channels, size;
      ...
      case IO_IOCTL_AUDIO_GET_IO_DATA_FORMAT:
         ...
         ((AUDIO_DATA_FORMAT_PTR) param_ptr)->SIZE = io_info_ptr->IO_FORMAT.SIZE;
         break;
      ...
      case IO_IOCTL_I2S_GET_TXFIFO_WATERMARK:
         ...
         *((uint8_t *) param_ptr) = i2s_ptr->FCSR & I2S_FCSR_TFWM0_MASK;
         break;
      ...
      case IO_IOCTL_I2S_GET_RXFIFO_WATERMARK:
         ...
         *((uint8_t *) param_ptr) = (i2s_ptr->FCSR & I2S_FCSR_RFWM0_MASK) >> I2S_FCSR_RFWM0_SHIFT;
         break;
...
*
*END*********************************************************************/
static uint32_t _ki2s_format_in_data
   (
    /* [IN] data to format */
    char *input,
...
uint32_t _ki2s_sine_wave(uint32_t fs, uint32_t freq, int16_t **output)
{
    uint32_t samples, i;
    bool over180 = 0;
    ieee_single period, step, angle = 0.0;
    period = 1 / (ieee_single) freq;
    samples = fs * (uint32_t)period;
    if (samples == 0)
    {
      return(0);
    }
    *output = (int16_t *) _mem_alloc(sizeof(int16_t) * samples);
    ...
    for(i = 0; i < samples; i++)
    {
        ...
        *((*output) + i) =  BIT16_MAX * (4*(uint32_t)angle*(180 - (uint32_t)angle))/(40500 - (uint32_t)angle * (180 - (uint32_t)angle));
        if (over180)
        {
           *((*output) + i) = -(*((*output) + i));
        }
...
)
{
   ...
   uint8_t channels = i2s_init_ptr->IO_FORMAT->CHANNELS;
...
*
*END*********************************************************************/
_mqx_uint _ki2s_set_mclk_value
(
    KI2S_INFO_STRUCT_PTR io_info_ptr,
    uint32_t frequency
)
{
    ...
    if (io_info_ptr->CLOCK_SOURCE == I2S_CLK_INT)
    {
        uint32_t fract, temp_fract = 0, divide, temp_div = 0, closest_mclk = 0, iter_mclk = 0;
        divider =(uint8_t) (BSP_SYSTEM_CLOCK / frequency);

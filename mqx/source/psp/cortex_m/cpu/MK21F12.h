...
#if !defined(MCU_MK21F12)  /* Check if memory map has not been already included */
#define MCU_MK21F12
...
#define UART_WP7816_T_TYPE0_REG(base)            This_symbol_has_been_deprecated
#define UART_WP7816_T_TYPE1_REG(base)            This_symbol_has_been_deprecated

...
**
**     Abstract:
**         This header file implements peripheral memory map for MK53DZ10
**         processor.
**
 ...
 * @version 1.6
 * @date 2013-04-05
 * @brief Peripheral memory map for MK53DZ10
 *
 * This header file implements peripheral memory map for MK53DZ10 processor.
 */
...
#if !defined(MCU_MK53DZ10)  /* Check if memory map has not been already included */
#define MCU_MK53DZ10

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error MK53DZ10 memory map: There is already included another memory map. Only one memory map can be included.

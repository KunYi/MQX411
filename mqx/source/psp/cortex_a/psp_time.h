...
extern void      _psp_subtract_ticks(PSP_TICK_STRUCT_PTR, PSP_TICK_STRUCT_PTR, 
   PSP_TICK_STRUCT_PTR);
extern int32_t    _psp_subtract_ticks_int32(PSP_TICK_STRUCT_PTR, PSP_TICK_STRUCT_PTR, 
   bool *);
extern void      _psp_mul_ticks_by_32(PSP_TICK_STRUCT_PTR, uint32_t,
   PSP_TICK_STRUCT_PTR);

extern bool   _psp_ticks_to_time(PSP_TICK_STRUCT_PTR, TIME_STRUCT_PTR);

extern uint32_t   _psp_ticks_to_days(PSP_TICK_STRUCT_PTR, bool *);
extern uint32_t   _psp_ticks_to_hours(PSP_TICK_STRUCT_PTR, bool *);
extern uint32_t   _psp_ticks_to_minutes(PSP_TICK_STRUCT_PTR, bool *);
extern uint32_t   _psp_ticks_to_seconds(PSP_TICK_STRUCT_PTR, bool *);
extern uint32_t   _psp_ticks_to_milliseconds(PSP_TICK_STRUCT_PTR, bool *);
extern uint32_t   _psp_ticks_to_microseconds(PSP_TICK_STRUCT_PTR, bool *);
extern uint32_t   _psp_ticks_to_nanoseconds(PSP_TICK_STRUCT_PTR, bool *);
extern uint32_t   _psp_ticks_to_picoseconds(PSP_TICK_STRUCT_PTR, bool *);

extern uint32_t   _psp_get_elapsed_milliseconds(void);

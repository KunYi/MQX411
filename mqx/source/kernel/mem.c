...
{ /* Body */
    ...
    STOREBLOCK_STRUCT_PTR block_ptr;
    STOREBLOCK_STRUCT_PTR prev_block_ptr;
    volatile STOREBLOCK_STRUCT_PTR next_block_ptr; /* volatile to avoid aggressive optimization especially in GCC */
    MEMPOOL_STRUCT_PTR mem_pool_ptr;
    TD_STRUCT_PTR td_ptr;
...
{ /* Body */
    volatile STOREBLOCK_STRUCT_PTR block_ptr; /* volatile to avoid aggressive optimization especially in GCC */
    STOREBLOCK_STRUCT_PTR next_block_ptr;

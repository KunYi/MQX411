...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk21d50m/PE_Types.h" "${OUTPUTDIR}/Generated_Code/PE_Types.h"
...
cp -f "${ROOTDIR}/mqx/source/io/adc/kadc/adc_mk21.h" "${OUTPUTDIR}/adc_mk21.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk21d50m/PE_LDD.h" "${OUTPUTDIR}/Generated_Code/PE_LDD.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk21d50m/bsp_cm.h" "${OUTPUTDIR}/bsp_cm.h"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk21d50m/bsp_rev.h" "${OUTPUTDIR}/bsp_rev.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk21d50m/twrk21d50m.h" "${OUTPUTDIR}/twrk21d50m.h"
...
cp -f "${ROOTDIR}/config/twrk21d50m/user_config.h" "${OUTPUTDIR}/../user_config.h"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk21d50m/bsp.h" "${OUTPUTDIR}/bsp.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk21d50m/init_lpm.h" "${OUTPUTDIR}/init_lpm.h"
...
if [ "${TOOL}" = "kds" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk21d50m/gcc_arm/intflash.ld" "${OUTPUTDIR}/intflash.ld"
mkdir -p "${OUTPUTDIR}/Generated_Code"

...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk40d100m/init_lpm.h" "${OUTPUTDIR}/init_lpm.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk40d100m/PE_Types.h" "${OUTPUTDIR}/Generated_Code/PE_Types.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk40d100m/bsp.h" "${OUTPUTDIR}/bsp.h"
cp -f "${ROOTDIR}/config/twrk40d100m/user_config.h" "${OUTPUTDIR}/../user_config.h"
...
cp -f "${ROOTDIR}/mqx/source/io/lcd/lcd_twrk40d100m.h" "${OUTPUTDIR}/lcd_twrk40d100m.h"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk40d100m/twrk40d100m.h" "${OUTPUTDIR}/twrk40d100m.h"
cp -f "${ROOTDIR}/mqx/source/io/can/flexcan/kflexcan.h" "${OUTPUTDIR}/kflexcan.h"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk40d100m/PE_LDD.h" "${OUTPUTDIR}/Generated_Code/PE_LDD.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk40d100m/bsp_cm.h" "${OUTPUTDIR}/bsp_cm.h"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk40d100m/bsp_rev.h" "${OUTPUTDIR}/bsp_rev.h"
...
if [ "${TOOL}" = "kds" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk40d100m/gcc_arm/intflash.ld" "${OUTPUTDIR}/intflash.ld"
mkdir -p "${OUTPUTDIR}/Generated_Code"

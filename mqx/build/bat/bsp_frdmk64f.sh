...
cp -f "${ROOTDIR}/mqx/source/bsp/frdmk64f/bsp_cm.h" "${OUTPUTDIR}/bsp_cm.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/frdmk64f/PE_Types.h" "${OUTPUTDIR}/Generated_Code/PE_Types.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/frdmk64f/frdmk64f.h" "${OUTPUTDIR}/frdmk64f.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/frdmk64f/PE_LDD.h" "${OUTPUTDIR}/Generated_Code/PE_LDD.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/frdmk64f/bsp.h" "${OUTPUTDIR}/bsp.h"
...
cp -f "${ROOTDIR}/config/frdmk64f/user_config.h" "${OUTPUTDIR}/../user_config.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/frdmk64f/init_lpm.h" "${OUTPUTDIR}/init_lpm.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/frdmk64f/bsp_rev.h" "${OUTPUTDIR}/bsp_rev.h"


# kds files
if [ "${TOOL}" = "kds" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/frdmk64f/gcc_arm/intflash.ld" "${OUTPUTDIR}/intflash.ld"

...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk60f120m/bsp_rev.h" "${OUTPUTDIR}/bsp_rev.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk60f120m/bsp_cm.h" "${OUTPUTDIR}/bsp_cm.h"
...
cp -f "${ROOTDIR}/config/twrk60f120m/user_config.h" "${OUTPUTDIR}/../user_config.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk60f120m/PE_Types.h" "${OUTPUTDIR}/Generated_Code/PE_Types.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk60f120m/bsp.h" "${OUTPUTDIR}/bsp.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk60f120m/twrk60f120m.h" "${OUTPUTDIR}/twrk60f120m.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk60f120m/PE_LDD.h" "${OUTPUTDIR}/Generated_Code/PE_LDD.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk60f120m/init_lpm.h" "${OUTPUTDIR}/init_lpm.h"
...
if [ "${TOOL}" = "kds" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk60f120m/gcc_arm/intflash.ld" "${OUTPUTDIR}/intflash.ld"

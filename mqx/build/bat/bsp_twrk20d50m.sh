...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk20d50m/PE_LDD.h" "${OUTPUTDIR}/Generated_Code/PE_LDD.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk20d50m/init_lpm.h" "${OUTPUTDIR}/init_lpm.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk20d50m/twrk20d50m.h" "${OUTPUTDIR}/twrk20d50m.h"
...
cp -f "${ROOTDIR}/mqx/source/io/flashx/freescale/flash_mk20.h" "${OUTPUTDIR}/flash_mk20.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk20d50m/PE_Types.h" "${OUTPUTDIR}/Generated_Code/PE_Types.h"
cp -f "${ROOTDIR}/mqx/source/io/rtc/krtc.h" "${OUTPUTDIR}/krtc.h"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk20d50m/bsp_cm.h" "${OUTPUTDIR}/bsp_cm.h"
...
cp -f "${ROOTDIR}/mqx/source/io/adc/kadc/adc_mk20.h" "${OUTPUTDIR}/adc_mk20.h"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk20d50m/bsp_rev.h" "${OUTPUTDIR}/bsp_rev.h"
...
cp -f "${ROOTDIR}/config/twrk20d50m/user_config.h" "${OUTPUTDIR}/../user_config.h"
cp -f "${ROOTDIR}/mqx/source/io/timer/qpit.h" "${OUTPUTDIR}/qpit.h"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk20d50m/bsp.h" "${OUTPUTDIR}/bsp.h"
...
if [ "${TOOL}" = "kds" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk20d50m/gcc_arm/intflash.ld" "${OUTPUTDIR}/intflash.ld"
mkdir -p "${OUTPUTDIR}/Generated_Code"

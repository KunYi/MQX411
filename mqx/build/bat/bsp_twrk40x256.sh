...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk40x256/bsp_rev.h" "${OUTPUTDIR}/bsp_rev.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk40x256/PE_LDD.h" "${OUTPUTDIR}/Generated_Code/PE_LDD.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk40x256/PE_Types.h" "${OUTPUTDIR}/Generated_Code/PE_Types.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk40x256/TSS_SystemSetup.h" "${OUTPUTDIR}/TSS_SystemSetup.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk40x256/bsp_cm.h" "${OUTPUTDIR}/bsp_cm.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk40x256/twrk40x256.h" "${OUTPUTDIR}/twrk40x256.h"
...
cp -f "${ROOTDIR}/config/twrk40x256/user_config.h" "${OUTPUTDIR}/../user_config.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk40x256/init_lpm.h" "${OUTPUTDIR}/init_lpm.h"
cp -f "${ROOTDIR}/mqx/source/io/adc/kadc/adc_mk40.h" "${OUTPUTDIR}/adc_mk40.h"
cp -f "${ROOTDIR}/mqx/source/io/lcd/lcd_twrk40x256.h" "${OUTPUTDIR}/lcd_twrk40x256.h"
cp -f "${ROOTDIR}/mqx/source/io/timer/qpit.h" "${OUTPUTDIR}/qpit.h"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk40x256/bsp.h" "${OUTPUTDIR}/bsp.h"
...
if [ "${TOOL}" = "kds" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk40x256/gcc_arm/intflash.ld" "${OUTPUTDIR}/intflash.ld"

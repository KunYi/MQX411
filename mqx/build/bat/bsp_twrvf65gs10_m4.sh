...
cp -f "${ROOTDIR}/mqx/source/bsp/twrvf65gs10_m4/bsp_rev.h" "${OUTPUTDIR}/bsp_rev.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrvf65gs10_m4/bsp.h" "${OUTPUTDIR}/bsp.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrvf65gs10_m4/bsp_cm.h" "${OUTPUTDIR}/bsp_cm.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrvf65gs10_m4/init_lpm.h" "${OUTPUTDIR}/init_lpm.h"
...
cp -f "${ROOTDIR}/config/twrvf65gs10_m4/user_config.h" "${OUTPUTDIR}/../user_config.h"
cp -f "${ROOTDIR}/mqx/source/io/i2c/i2c.h" "${OUTPUTDIR}/i2c.h"
cp -f "${ROOTDIR}/mqx/source/bsp/twrvf65gs10_m4/twrvf65gs10_m4.h" "${OUTPUTDIR}/twrvf65gs10_m4.h"
...
if [ "${TOOL}" = "ds5" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrvf65gs10_m4/ds5/ram.scf" "${OUTPUTDIR}/ram.scf"
...
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrvf65gs10_m4/gcc_arm/ram.ld" "${OUTPUTDIR}/ram.ld"
mkdir -p "${OUTPUTDIR}/Generated_Code"
mkdir -p "${OUTPUTDIR}/Sources"
:
fi

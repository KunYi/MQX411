...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk64f120m/PE_Types.h" "${OUTPUTDIR}/Generated_Code/PE_Types.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk64f120m/twrk64f120m.h" "${OUTPUTDIR}/twrk64f120m.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk64f120m/bsp_rev.h" "${OUTPUTDIR}/bsp_rev.h"
...
cp -f "${ROOTDIR}/mqx/source/io/enet/macnet/macnet_mk64.h" "${OUTPUTDIR}/macnet_mk64.h"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk64f120m/init_lpm.h" "${OUTPUTDIR}/init_lpm.h"
...
cp -f "${ROOTDIR}/mqx/source/io/flashx/freescale/flash_mk64.h" "${OUTPUTDIR}/flash_mk64.h"
...
cp -f "${ROOTDIR}/config/twrk64f120m/user_config.h" "${OUTPUTDIR}/../user_config.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk64f120m/PE_LDD.h" "${OUTPUTDIR}/Generated_Code/PE_LDD.h"
...
cp -f "${ROOTDIR}/mqx/source/io/adc/kadc/adc_mk64.h" "${OUTPUTDIR}/adc_mk64.h"
cp -f "${ROOTDIR}/mqx/source/io/hwtimer/hwtimer_systick.h" "${OUTPUTDIR}/hwtimer_systick.h"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk64f120m/bsp.h" "${OUTPUTDIR}/bsp.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk64f120m/bsp_cm.h" "${OUTPUTDIR}/bsp_cm.h"
...
if [ "${TOOL}" = "kds" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk64f120m/gcc_arm/intflash.ld" "${OUTPUTDIR}/intflash.ld"

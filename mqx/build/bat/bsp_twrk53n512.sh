...
cp -f "${ROOTDIR}/mqx/source/io/lcd/lcd_twrk53n512.h" "${OUTPUTDIR}/lcd_twrk53n512.h"
...
cp -f "${ROOTDIR}/mqx/source/io/flashx/freescale/flash_mk53.h" "${OUTPUTDIR}/flash_mk53.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk53n512/bsp_rev.h" "${OUTPUTDIR}/bsp_rev.h"
...
cp -f "${ROOTDIR}/config/twrk53n512/user_config.h" "${OUTPUTDIR}/../user_config.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk53n512/bsp.h" "${OUTPUTDIR}/bsp.h"
cp -f "${ROOTDIR}/mqx/source/io/usb_dcd/usb_dcd.h" "${OUTPUTDIR}/usb_dcd.h"
cp -f "${ROOTDIR}/mqx/source/io/lpm/lpm.h" "${OUTPUTDIR}/lpm.h"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk53n512/init_lpm.h" "${OUTPUTDIR}/init_lpm.h"
cp -f "${ROOTDIR}/mqx/source/io/sdcard/sdcard_esdhc/sdcard_esdhc.h" "${OUTPUTDIR}/sdcard_esdhc.h"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk53n512/PE_LDD.h" "${OUTPUTDIR}/Generated_Code/PE_LDD.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk53n512/TSS_SystemSetup.h" "${OUTPUTDIR}/TSS_SystemSetup.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk53n512/twrk53n512.h" "${OUTPUTDIR}/twrk53n512.h"
...
cp -f "${ROOTDIR}/mqx/source/io/enet/macnet/macnet_mk53.h" "${OUTPUTDIR}/macnet_mk53.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk53n512/bsp_cm.h" "${OUTPUTDIR}/bsp_cm.h"
...
cp -f "${ROOTDIR}/mqx/source/io/adc/kadc/adc_mk53.h" "${OUTPUTDIR}/adc_mk53.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk53n512/PE_Types.h" "${OUTPUTDIR}/Generated_Code/PE_Types.h"
...
if [ "${TOOL}" = "kds" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk53n512/gcc_arm/intflash.ld" "${OUTPUTDIR}/intflash.ld"

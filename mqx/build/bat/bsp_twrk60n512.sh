...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk60n512/bsp_rev.h" "${OUTPUTDIR}/bsp_rev.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk60n512/bsp_cm.h" "${OUTPUTDIR}/bsp_cm.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk60n512/twrk60n512.h" "${OUTPUTDIR}/twrk60n512.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk60n512/TSS_SystemSetup.h" "${OUTPUTDIR}/TSS_SystemSetup.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk60n512/bsp.h" "${OUTPUTDIR}/bsp.h"
...
cp -f "${ROOTDIR}/mqx/source/io/flashx/freescale/flash_mk60.h" "${OUTPUTDIR}/flash_mk60.h"
...
cp -f "${ROOTDIR}/mqx/source/io/enet/macnet/macnet_mk60.h" "${OUTPUTDIR}/macnet_mk60.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk60n512/init_lpm.h" "${OUTPUTDIR}/init_lpm.h"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk60n512/PE_Types.h" "${OUTPUTDIR}/Generated_Code/PE_Types.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/twrk60n512/PE_LDD.h" "${OUTPUTDIR}/Generated_Code/PE_LDD.h"
...
cp -f "${ROOTDIR}/mqx/source/io/adc/kadc/adc_mk60.h" "${OUTPUTDIR}/adc_mk60.h"
...
cp -f "${ROOTDIR}/config/twrk60n512/user_config.h" "${OUTPUTDIR}/../user_config.h"
...
if [ "${TOOL}" = "kds" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk60n512/gcc_arm/intflash.ld" "${OUTPUTDIR}/intflash.ld"

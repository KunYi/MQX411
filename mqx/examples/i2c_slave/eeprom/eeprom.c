...
#ifdef BSPCFG_ENABLE_LEGACY_II2C_SLAVE
    #if !BSPCFG_ENABLE_LEGACY_II2C_SLAVE
    #error This application requires BSPCFG_ENABLE_LEGACY_II2C_SLAVE defined non-zero in user_config.h. Please recompile BSP with this option.
    #endif
#endif
   ...
   )
{
   ...
   printf ("\nEEPROM I2C slave example - 256 byte EEPROM emulation\n\n");

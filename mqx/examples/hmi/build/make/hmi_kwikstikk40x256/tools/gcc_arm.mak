...
LIBRARIES += $(MQX_ROOTDIR)/lib/kwikstikk40x256.gcc_arm/debug/bsp/tss.a
LIBRARIES += $(MQX_ROOTDIR)/lib/kwikstikk40x256.gcc_arm/debug/shell/shell.a
endif
ifeq ($(CONFIG),release)
...
LIBRARIES += $(MQX_ROOTDIR)/lib/kwikstikk40x256.gcc_arm/release/bsp/tss.a
LIBRARIES += $(MQX_ROOTDIR)/lib/kwikstikk40x256.gcc_arm/release/shell/shell.a
endif
...
INCLUDE += $(MQX_ROOTDIR)/lib/kwikstikk40x256.gcc_arm/debug/bsp/Sources
...
INCLUDE += $(MQX_ROOTDIR)/lib/kwikstikk40x256.gcc_arm/debug/bsp/tss
INCLUDE += $(MQX_ROOTDIR)/lib/kwikstikk40x256.gcc_arm/debug/shell
endif
ifeq ($(CONFIG),release)
INCLUDE += $(MQX_ROOTDIR)/lib/kwikstikk40x256.gcc_arm/release/bsp/Generated_Code
INCLUDE += $(MQX_ROOTDIR)/lib/kwikstikk40x256.gcc_arm/release/bsp/Sources
...
INCLUDE += $(MQX_ROOTDIR)/lib/kwikstikk40x256.gcc_arm/release/bsp/tss
INCLUDE += $(MQX_ROOTDIR)/lib/kwikstikk40x256.gcc_arm/release/shell
endif

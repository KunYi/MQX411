...
const TASK_TEMPLATE_STRUCT  MQX_template_list[] = 
{
   /* Task Index, Function,  Stack, Priority,  Name,        Attributes,          Param, Time Slice */
    { LWSEMB,     LWSemB,    0x300,    10,     "LWSemB",    MQX_USER_TASK,                   0,     0 },
    { LWSEMA,     LWSemA,    0x300,     9,     "LWSemA",    MQX_USER_TASK,                   0,     0 },
    { LWEVENTB,   LWEventB,  0x300,     9,     "LWEventB",  MQX_USER_TASK,                   0,     0 },
    { LWEVENTA,   LWEventA,  0x300,     9,     "LWEventA",  MQX_USER_TASK,                   0,     0 },
    { SENDER,     Sender,    0x300,    10,     "Sender",    0,                   0,     0 },
    { RESPONDER,  Responder, 0x300,     9,     "Responder", MQX_USER_TASK,                   0,     0 },

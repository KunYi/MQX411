...
//extern const AUD_CODEC_CS48560_INIT_PARAM_STRUCT _bsp_dsp48560_init;
...
const TASK_TEMPLATE_STRUCT  MQX_template_list[] =
{
   /* Task Index,   Function,     Stack,  Priority, Name,     Attributes,          Param, Time Slice */
    { 2,            shell_task,   6000,     12,     "Shell",  MQX_AUTO_START_TASK, 0,     0 },

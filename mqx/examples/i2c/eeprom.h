...
/* Function prototypes */
extern void i2c_write_eeprom_polled (MQX_FILE_PTR, uint32_t, unsigned char *, _mqx_int);
extern void i2c_read_eeprom_polled (MQX_FILE_PTR, uint32_t, unsigned char *, _mqx_int);
extern void i2c_write_eeprom_interrupt (MQX_FILE_PTR, uint32_t, unsigned char *, _mqx_int);
extern void i2c_read_eeprom_interrupt (MQX_FILE_PTR, uint32_t, unsigned char *, _mqx_int);

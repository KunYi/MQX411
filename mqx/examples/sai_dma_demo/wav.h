...
{
    /* 
    * ChunkID. Contains the letters "RIFF" 
    * in ASCII form (0x52494646 big-endian form). 
    */
    char ChunkID[5];
...
extern "C" {
    ...
    extern _mqx_int GetWaveHeader(char *filename, WAVE_FILE_HEADER_PTR header);
	extern _mqx_int SetWaveHeader(char *format, WAVE_FILE_HEADER_PTR header, uint8_t *buffer);

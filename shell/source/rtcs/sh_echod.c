...
#define SHELL_ECHO_STACK       2000


/*FUNCTION*-------------------------------------------------------------
*
*  Function Name :  Shell_Echod
*  Returned Value:  none
...
int32_t  Shell_Echod(int32_t argc, char *argv[] )
{
   uint32_t  result;
   ...
   if (!print_usage)  {
      if (argc == 2)  {
         if (strcmp(argv[1], "start") == 0)  {
            ...
            result = ECHOSRV_init("ECHO_server", SHELL_ECHO_PRIO, SHELL_ECHO_STACK );
            if (result ==  0)  {

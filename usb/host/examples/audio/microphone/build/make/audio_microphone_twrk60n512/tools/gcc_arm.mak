...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60n512.gcc_arm/debug/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60n512.gcc_arm/debug/shell/shell.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60n512.gcc_arm/debug/usb/usbh.a
endif
ifeq ($(CONFIG),release)
...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60n512.gcc_arm/release/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60n512.gcc_arm/release/shell/shell.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60n512.gcc_arm/release/usb/usbh.a
endif
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60n512.gcc_arm/debug/mfs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60n512.gcc_arm/debug/shell
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60n512.gcc_arm/debug/usb
endif
ifeq ($(CONFIG),release)
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60n512.gcc_arm/release/mfs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60n512.gcc_arm/release/shell
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60n512.gcc_arm/release/usb
endif

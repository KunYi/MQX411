...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk40x256.kds/debug/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk40x256.kds/debug/shell/shell.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk40x256.kds/debug/usb/usbh.a
endif
ifeq ($(CONFIG),release)
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk40x256.kds/release/bsp/bsp.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk40x256.kds/release/psp/psp.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk40x256.kds/release/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk40x256.kds/release/shell/shell.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk40x256.kds/release/usb/usbh.a
endif
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk40x256.kds/debug/bsp/Sources
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk40x256.kds/debug/mfs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk40x256.kds/debug/shell
INCLUDE += $(MQX_ROOTDIR)/lib/twrk40x256.kds/debug/usb
endif
ifeq ($(CONFIG),release)
INCLUDE += $(MQX_ROOTDIR)/lib/twrk40x256.kds/release/bsp/Generated_Code
INCLUDE += $(MQX_ROOTDIR)/lib/twrk40x256.kds/release/bsp/Sources
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk40x256.kds/release/mfs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk40x256.kds/release/shell
INCLUDE += $(MQX_ROOTDIR)/lib/twrk40x256.kds/release/usb
endif

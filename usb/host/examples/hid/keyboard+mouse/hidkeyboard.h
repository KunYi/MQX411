...
void usb_host_hid_keyboard_recv_callback(_usb_pipe_handle, void *, unsigned char *, uint32_t, USB_STATUS);
void usb_host_hid_keyboard_ctrl_callback(_usb_pipe_handle, void *, unsigned char *, uint32_t, USB_STATUS);

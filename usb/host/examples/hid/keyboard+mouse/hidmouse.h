...
void usb_host_hid_mouse_recv_callback(_usb_pipe_handle, void *, unsigned char *, uint32_t,
   uint32_t);
void usb_host_hid_mouse_ctrl_callback(_usb_pipe_handle, void *, unsigned char *, uint32_t,
   uint32_t);

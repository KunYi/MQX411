...
*
*END************************************************************************/
#include <psp.h> //for _PSP_SYNC()
#include <bsp.h> //for endianess specification
...
#define  VUSBHS_PORTSCX_PORT_PFSC                  (0x01000000)
...
#define  EHCIFSL_GTCTL_GPTIMER_REPEAT              (0x01000000)
#define  EHCIFSL_GTCTL_GPTIMER_RESET               (0x40000000)
#define  EHCIFSL_GTCTL_GPTIMER_RUN                 (0x80000000)

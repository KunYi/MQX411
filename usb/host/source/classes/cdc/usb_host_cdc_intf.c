...
static void usb_class_cdc_bind_data_interface(CLASS_CALL_STRUCT_PTR, void *);
static void usb_class_cdc_bind_ctrl_interface(CLASS_CALL_STRUCT_PTR, void *);
static void usb_class_cdc_register_interface(CLASS_CALL_STRUCT_PTR, CLASS_CALL_STRUCT_PTR *);
static void usb_class_cdc_unregister_interface(CLASS_CALL_STRUCT_PTR, CLASS_CALL_STRUCT_PTR *);
        ...
        switch (fd->header.bDescriptorSubtype) {
            case USB_DESC_SUBTYPE_CS_HEADER:
                *header_desc = &fd->header;
                if (SHORT_LE_TO_HOST(*(uint16_t*)((*header_desc)->bcdCDC)) > 0x0110)
                    status = USBERR_INIT_FAILED;
                break;

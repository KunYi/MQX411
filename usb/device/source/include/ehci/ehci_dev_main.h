...
typedef  volatile uint32_t  USB_REGISTER, * USB_REGISTER_PTR;
...
} USBHS_REG_STRUCT, * USBHS_REG_STRUCT_PTR;
...
typedef volatile struct {
   ...
   uint32_t   RESERVED1;
   unsigned char     SETUP_BUFFER[8];     /* 8 bytes of setup data that follows
                                  ** the Setup PID
                                  */
...
void _usb_dci_usbhs_free_dTD(_usb_device_handle, void *);
uint8_t _usb_dci_usbhs_add_dTD(_usb_device_handle, XD_STRUCT_PTR);
...
USB_STATUS _usb_dci_usbhs_set_test_mode(_usb_device_handle, uint16_t);
void _usb_dci_usbhs_chip_initialize(_usb_device_handle);


USB_STATUS _usb_dci_usbhs_preinit(_usb_device_handle *);
...
USB_STATUS _usb_dci_usbhs_cancel_transfer(_usb_device_handle, uint8_t, uint8_t);
USB_STATUS _usb_dci_usbhs_set_address(_usb_device_handle, uint8_t);
USB_STATUS _usb_dci_usbhs_shutdown(_usb_device_handle);
USB_STATUS _usb_dci_usbhs_get_setup_data(_usb_device_handle, uint8_t, uint8_t *);
...
USB_STATUS _usb_dci_usbhs_stall_endpoint(_usb_device_handle, uint8_t, uint8_t);
USB_STATUS _usb_dci_usbhs_unstall_endpoint(_usb_device_handle, uint8_t, uint8_t);
USB_STATUS _usb_dci_usbhs_deinit_endpoint(_usb_device_handle, uint8_t, uint8_t);
USB_STATUS _usb_dci_usbhs_get_endpoint_status(_usb_device_handle, uint8_t, uint16_t *);
USB_STATUS _usb_dci_usbhs_set_endpoint_status(_usb_device_handle, uint8_t, uint16_t);
USB_STATUS _usb_dci_usbhs_get_transfer_status(_usb_device_handle, uint8_t, uint8_t);

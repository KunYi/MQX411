...
typedef union _DATA_apdu_union DATA_apdu_union;

PACKED_STRUCT_BEGIN
struct _DATA_apdu_struct_choice
{
    intu16 choice;
    intu16 length;
...
typedef struct _DATA_apdu_struct_choice DATA_apdu_struct_choice;
...
struct _DATA_apdu
{
    ...
    DATA_apdu_struct_choice choice;
} PACKED_STRUCT_END;
typedef struct _DATA_apdu DATA_apdu;

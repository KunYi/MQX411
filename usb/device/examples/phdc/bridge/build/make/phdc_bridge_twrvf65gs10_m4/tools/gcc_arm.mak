...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrvf65gs10_m4.gcc_arm/debug/rtcs/rtcs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrvf65gs10_m4.gcc_arm/debug/usb/usbd.a
endif
ifeq ($(CONFIG),release)
...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrvf65gs10_m4.gcc_arm/release/rtcs/rtcs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrvf65gs10_m4.gcc_arm/release/usb/usbd.a
endif
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrvf65gs10_m4.gcc_arm/debug/rtcs
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrvf65gs10_m4.gcc_arm/release/rtcs

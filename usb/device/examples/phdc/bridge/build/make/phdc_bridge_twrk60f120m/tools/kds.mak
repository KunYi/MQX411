...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.kds/debug/rtcs/rtcs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.kds/debug/usb/usbd.a
endif
ifeq ($(CONFIG),release)
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.kds/release/bsp/bsp.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.kds/release/psp/psp.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.kds/release/rtcs/rtcs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.kds/release/usb/usbd.a
endif
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60f120m.kds/debug/bsp/Sources
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60f120m.kds/debug/rtcs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60f120m.kds/debug/usb
endif
ifeq ($(CONFIG),release)
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60f120m.kds/release/bsp/Generated_Code
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60f120m.kds/release/bsp/Sources
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60f120m.kds/release/rtcs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60f120m.kds/release/usb
endif

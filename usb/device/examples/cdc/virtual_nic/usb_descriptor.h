...
extern uint8_t USB_Desc_Get_Line_Coding(uint32_t handle, 
                                       uint8_t interface, 
                                       uint8_t **coding_data);

extern uint8_t USB_Desc_Set_Line_Coding(uint32_t handle, 
                                       uint8_t interface, 
                                       uint8_t **coding_data);                                       

extern uint8_t USB_Desc_Get_Abstract_State(uint32_t handle, 
                                          uint8_t interface, 
                                          uint8_t **feature_data);
extern uint8_t USB_Desc_Get_Country_Setting(uint32_t handle, 
                                          uint8_t interface, 
                                          uint8_t **feature_data);
extern uint8_t USB_Desc_Set_Abstract_State(uint32_t handle, 
                                          uint8_t interface, 
                                          uint8_t **feature_data);
extern uint8_t USB_Desc_Set_Country_Setting(uint32_t handle, 
                                          uint8_t interface, 
                                          uint8_t **feature_data);                                                                                    

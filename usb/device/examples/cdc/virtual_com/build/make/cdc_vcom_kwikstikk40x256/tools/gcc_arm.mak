...
LIBRARIES += $(MQX_ROOTDIR)/lib/kwikstikk40x256.gcc_arm/debug/usb/usbd.a
endif
ifeq ($(CONFIG),release)
...
LIBRARIES += $(MQX_ROOTDIR)/lib/kwikstikk40x256.gcc_arm/release/usb/usbd.a
endif
...
INCLUDE += $(MQX_ROOTDIR)/lib/kwikstikk40x256.gcc_arm/debug/usb
endif
ifeq ($(CONFIG),release)
...
INCLUDE += $(MQX_ROOTDIR)/lib/kwikstikk40x256.gcc_arm/release/usb
endif

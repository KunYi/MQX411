...
LIBRARIES += $(MQX_ROOTDIR)/lib/kwikstikk40x256.kds/debug/usb/usbd.a
endif
ifeq ($(CONFIG),release)
...
LIBRARIES += $(MQX_ROOTDIR)/lib/kwikstikk40x256.kds/release/usb/usbd.a
endif
...
INCLUDE += $(MQX_ROOTDIR)/lib/kwikstikk40x256.kds/debug/usb
endif
ifeq ($(CONFIG),release)
...
INCLUDE += $(MQX_ROOTDIR)/lib/kwikstikk40x256.kds/release/usb
endif

...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21f120m.kds/debug/usb/usbh.a
endif
ifeq ($(CONFIG),release)
...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21f120m.kds/release/usb/usbh.a
endif
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk21f120m.kds/debug/usb
endif
ifeq ($(CONFIG),release)
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk21f120m.kds/release/usb
endif

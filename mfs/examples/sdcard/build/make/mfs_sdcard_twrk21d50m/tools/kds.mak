...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21d50m.kds/debug/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21d50m.kds/debug/shell/shell.a
endif
ifeq ($(CONFIG),release)
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21d50m.kds/release/bsp/bsp.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21d50m.kds/release/psp/psp.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21d50m.kds/release/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21d50m.kds/release/shell/shell.a
endif
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk21d50m.kds/debug/bsp/Sources
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk21d50m.kds/debug/mfs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk21d50m.kds/debug/shell
endif
ifeq ($(CONFIG),release)
INCLUDE += $(MQX_ROOTDIR)/lib/twrk21d50m.kds/release/bsp/Generated_Code
INCLUDE += $(MQX_ROOTDIR)/lib/twrk21d50m.kds/release/bsp/Sources
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk21d50m.kds/release/mfs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk21d50m.kds/release/shell
endif

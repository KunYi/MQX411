...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrvf65gs10_m4.gcc_arm/debug/mcc/mcc.a
endif
ifeq ($(CONFIG),release)
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrvf65gs10_m4.gcc_arm/debug/mcc
endif
ifeq ($(CONFIG),release)
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrvf65gs10_m4.gcc_arm/release/mcc
endif

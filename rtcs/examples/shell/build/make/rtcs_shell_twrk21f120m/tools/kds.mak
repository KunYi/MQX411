...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21f120m.kds/debug/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21f120m.kds/debug/rtcs/rtcs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21f120m.kds/debug/shell/shell.a
endif
ifeq ($(CONFIG),release)
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21f120m.kds/release/bsp/bsp.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21f120m.kds/release/psp/psp.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21f120m.kds/release/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21f120m.kds/release/rtcs/rtcs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk21f120m.kds/release/shell/shell.a
endif
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk21f120m.kds/debug/mfs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk21f120m.kds/debug/rtcs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk21f120m.kds/debug/shell
endif
ifeq ($(CONFIG),release)
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk21f120m.kds/release/mfs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk21f120m.kds/release/rtcs
INCLUDE += $(MQX_ROOTDIR)/lib/twrk21f120m.kds/release/shell
endif
